...
const esClient = new elasticsearch.Client({
  host: [
    {
      host: "ca2cd6e5696441b7a7544b8cfb848d36.us-east-1.aws.found.io",
      protocol: "https",
      port: 9243,
      auth: `elastic:uXLxyAqe6P88M1hlQmLrt4KU`,
    }
  ]
});


// searching using multiple attributes
// esClient.search({
//   index: 'referral',
//   body: {
//       "query": {
...
//                   {
//                       "match": {
//                           referrerType: req.body.,
//                       }
//                   },
//                   {
//                       "match": {
//                           referrerType: req._id
//                       }
//                   }
//               ]
//           }
